...
import hust.soict.hedspi.exception.LuckyItemException;
    ...
    public MenuFrame(JFrame jFrame) {
        ...
        deleteButton.addActionListener(e -> {
            if (anOrder != null) {
                ...
                if (anOrder.removeMedia(id) == 1) {
                    JOptionPane.showMessageDialog(null, "Delete Media have ID = " + id + " sucessfully");
                } else {
                    JOptionPane.showMessageDialog(null, "Don't exist Media have ID = " + id, "Warning", JOptionPane.WARNING_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(null, "Please create an order", "Warning", JOptionPane.WARNING_MESSAGE);
            }
